        ...
        <div class="page__row page__row_head page__row_border">
          ...
          <div class="page__col">
            <div class="header"><button class="header__burger"></button>
              <div class="search">
                <div class="search__field"><input class="search__input" type="text" placeholder="Search" /><button
                ...
                <div class="search__result">
                  ...
                  <div class="search__list"><a class="search__item" href="#">
                      ...
                      <div class="search__preview bg-blue-light"><img class="search__pic" src="img/figure-3.png"
                          alt="" /></div>
                ...
                <div class="notifications__wrap">
                  ...
                  <div class="notifications__list"><a class="notifications__item" href="notifications.html">
                      <div class="notifications__ava"><img class="notifications__pic" src="img/ava-1.png" alt="" />
                        <div class="notifications__status bg-blue"><img class="notifications__pic" src="img/chat.html"
                            alt="" /></div>
                      </div>
                      <div class="notifications__details">
                        ...
                        <div class="notifications__text caption-sm">Commented on <span
                            class="notifications__project">Collab Design</span></div>
                      </div>
                    </a><a class="notifications__item" href="notifications.html">
                      <div class="notifications__ava"><img class="notifications__pic" src="img/ava-1.png" alt="" />
                        <div class="notifications__status bg-green"><img class="notifications__pic" src="img/bag.svg"
                            alt="" /></div>
                      </div>
                      <div class="notifications__details">
                        <div class="notifications__line">
                        ...
                        <div class="notifications__text caption-sm">Just pushaded <span
                            class="notifications__project">Sapiens Illustration</span></div>
                      </div>
                    </a><a class="notifications__item" href="notifications.html">
                      <div class="notifications__ava"><img class="notifications__pic" src="img/ava-1.png" alt="" />
                        <div class="notifications__status bg-purple"><img class="notifications__pic"
                            src="img/message.svg" alt="" /></div>
                      </div>
                      <div class="notifications__details">
                        <div class="notifications__line">
                          <div class="notifications__user caption">Sarah Saunders</div>
                      ...
                      <div class="notifications__ava"><img class="notifications__pic" src="img/ava-1.png" alt="" />
                        <div class="notifications__status bg-red"><img class="notifications__pic" src="img/heart.svg"
                            alt="" /></div>
                      </div>
                      <div class="notifications__details">
                        <div class="notifications__line">
                  ...
                  <div class="notifications__btns"><a class="notifications__btn btn btn_black"
                      href="notifications.html">See all incoming activity</a></div>
                </div>
          ...
          <div class="page__col">
            <div class="slider">
              <div class="slider__container">
                <div class="slider__inner owl-carousel js-slider">
                  <div class="slider__item">
                    <div class="slider__details">
                      <div class="slider__title h5">Set a Google Analytics Code</div>
                      <div class="slider__text">Did you know you can set a Google Analytics code for your products?
                      </div><a class="slider__btn btn btn_white js-popup-open" href="#popup-settings"
                        data-effect="mfp-zoom-in">Settings</a>
                    </div>
                    <div class="slider__preview"><img class="slider__pic" src="img/slider-pic.png" alt=""></div>
                  </div>
                  <div class="slider__item">
                    <div class="slider__details">
                      <div class="slider__title h5">Set a Google Analytics Code</div>
                ...
                </div><button class="slider__close"><svg class="icon icon-remove">
            ...
            <div class="page__widgets">
              <div class="widget widget_shadow">
                ...
                <div class="widget__list"><a class="widget__item" href="products.html">
                    <div class="widget__preview bg-pink"><img class="widget__pic" src="img/figure-1.png" alt=""></div>
                    <div class="widget__details">
                      <div class="widget__category title">Bento 3D Kit<svg class="icon icon-arrow-right">
                          <use xlink:href="img/sprite.svg#icon-arrow-right"></use>
                        </svg></div>
                      <div class="widget__info caption">Illustration</div>
                    </div>
                  </a><a class="widget__item" href="products.html">
                    <div class="widget__preview bg-yellow"><img class="widget__pic" src="img/figure-2.png" alt=""></div>
                    <div class="widget__details">
                      <div class="widget__category title">Bento 3D Kit<svg class="icon icon-arrow-right">
                          <use xlink:href="img/sprite.svg#icon-arrow-right"></use>
                        </svg></div>
                    ...
                    <div class="widget__preview bg-blue-light"><img class="widget__pic" src="img/figure-3.png" alt="">
                    </div>
                    <div class="widget__details">
                      <div class="widget__category title">Collab UI Kit<svg class="icon icon-arrow-right">
                          <use xlink:href="img/sprite.svg#icon-arrow-right"></use>
                        </svg></div>
                      <div class="widget__info caption">Coded Template</div>
                    </div>
                  </a></div>
              </div>
              <div class="widget widget_chart widget_pink">
                <div class="widget__title">Earnings</div>
          ...
          <div class="page__col">
            <div class="page__group">
              <div class="widget widget_stat widget_pb60">
                <div class="widget__title">Your earning this month</div>
                <div class="widget__counter title title_md color-purple">479.4</div>
                <div class="widget__text">Update your payout method in Settings</div><a
                  class="widget__btn btn btn_white btn_wide" href="payouts.html">Withdraw All Earnings</a>
              </div>
              <div class="widget widget_empty widget_p0">
                <div class="widget__title">Affiliate Impressions</div>
